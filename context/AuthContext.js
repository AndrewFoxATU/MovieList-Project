// AuthContext
// - Purpose: Provides JWT auth state across the app. Persists token in
//   expo-secure-store so the user stays logged in between launches. Calls
//   setToken() from api/authToken.js so every outbound fetch picks up the
...
export function AuthProvider({ children }) {
  ...
  // On mount, restore persisted token so returning users skip the auth stack.
  useEffect(() => {
